 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(2);var invariant=__webpack_require__(5);var warning=__webpack_require__(7);var ExecutionEnvironment=__webpack_require__(11);var _assign=__webpack_require__(4);var emptyFunction$1=__webpack_require__(3);var EventListener=__webpack_require__(12);var getActiveElement=__webpack_require__(13);var shallowEqual=__webpack_require__(14);var containsNode=__webpack_require__(15);var focusNode=__webpack_require__(16);var emptyObject=__webpack_require__(6);var checkPropTypes=__webpack_require__(8);var hyphenateStyleName=__webpack_require__(31);var camelizeStyleName=__webpack_require__(33);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
...
var _UserDisplay = __webpack_require__(59);
...
var _UserAddNew = __webpack_require__(61);

var _UserAddNew2 = _interopRequireDefault(_UserAddNew);

var _UserEdit = __webpack_require__(62);
...
var App = function (_React$Component) {
  ...
  function App() {
    ...
    _this.generateMainPane = _this.generateMainPane.bind(_this);
    _this.handleListItemClick = _this.handleListItemClick.bind(_this);
    _this.retrieveAllUsers = _this.retrieveAllUsers.bind(_this);
  ...
  _createClass(App, [{
    ...
    key: 'generateMainPane',
    value: function generateMainPane() {
      var _this2 = this;

      if (this.state.mode === 'welcome') {
        return _react2.default.createElement(_Welcome2.default, { welcomeMessage: this.state.welcomeMessage });
      }
...
var _UserListItem = __webpack_require__(56);
...
var UserListItem = function UserListItem(_ref) {
  ...
  var passClick = function passClick(e) {
...
Welcome.propTypes = {
  welcomeMessage: _propTypes2.default.string.isRequired
};
...
var UserAddNew = function (_React$Component) {
  _inherits(UserAddNew, _React$Component);

  function UserAddNew(props) {
    _classCallCheck(this, UserAddNew);

    var _this = _possibleConstructorReturn(this, (UserAddNew.__proto__ || Object.getPrototypeOf(UserAddNew)).call(this, props));
    ...
    _this.handleChangeFN = _this.handleChangeFN.bind(_this);
  ...
  _createClass(UserAddNew, [{
    ...
    key: 'handleChangeFN',
    value: function handleChangeFN(event) {
      this.setState({ fullName: event.target.value });
    }
  }, {
    key: 'handleChangePU',
    value: function handleChangePU(event) {
      this.setState({ photoURL: event.target.value });
    }
  }, {
    key: 'handleChangeBL',
    value: function handleChangeBL(event) {
